...
(function(){
  const data = [
    ...
    { name: "Lucas Rodríguez",   time: "2:30 pm",  text: "Los cajeros de bettroya responden muy rápido y son bastante atentos." },
    ...
    { name: "Bianca Zapata",     time: "9:40 am",  text: "Los cajeros de bettroya son rápidos y el soporte resolvió una duda al toque." },
    ...
    { name: "Victoria Pereyra",  time: "6:22 pm",  text: "Los cajeros de bettroya responden muy rápido." },
    ...
    { name: "Rodrigo Ledesma",   time: "9:35 am",  text: "Los cajeros de bettroya me dieron respuesta enseguida." },
